...
namespace DL.DataAccess
{
    public class ReceiversRepository : IRepository<Receiver>
    {
        ...
        {
            var sqlQuery = $"update Receivers set DeletedDate = {DateTime.Now} where Id = @id";
        ...
        {
            var sqlQuery = "update Receivers set FullName = @FullName and Address = @Address where Id = @Id";
